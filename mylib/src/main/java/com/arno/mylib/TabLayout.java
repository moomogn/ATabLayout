...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabIndicatorPadding = a.getDimensionPixelOffset(R.styleable.TabLayout_tabIndicatorPadding,0);
        ...
        try {
            mTabTextSize = ta.getDimensionPixelSize(
                    android.support.v7.appcompat.R.styleable.TextAppearance_android_textSize, dpToPx(10));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.w("AAA", "onMeasure: default==" + getDefaultHeight() + "==top==" + getPaddingTop() + "==bottom==" + getPaddingBottom());
        Log.e("AAA", "idealHeight==" + idealHeight + "==heightMeasureSpec==" + MeasureSpec.getSize(heightMeasureSpec));
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void setIndicatorPosition(int left, int right) {
            if (left != mIndicatorLeft || right != mIndicatorRight) {
                ...
                mIndicatorLeft = left == -1 ? -1 : left + mTabIndicatorPadding;
                mIndicatorRight = right == -1 ? -1 : right - mTabIndicatorPadding;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
